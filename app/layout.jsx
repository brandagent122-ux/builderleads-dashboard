  ...
  return (
    <aside className="w-[240px] bg-navy-900 border-r border-navy-600 flex flex-col p-0 sticky top-0 h-screen">
      ...
      <nav className="flex-1 py-4 px-3 flex flex-col gap-1">
        ...
        <NavLink href="/saved" icon={<StarIcon />} label="Saved Leads" />
        <NavLink href="/reports" icon={<FileIcon />} label="Reports" />
        <NavLink href="/settings" icon={<GearIcon />} label="Settings" />
      </nav>
...
function StarIcon() { return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> }
function FileIcon() { return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> }
